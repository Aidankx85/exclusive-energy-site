...
export default function WarehousePortfolioPage() {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full mx-auto flex bg-white/90 rounded-3xl shadow-2xl overflow-hidden flex-col md:flex-row">
          <div className="md:w-1/2 flex items-center justify-center p-8">
            <Image
              src="https://res.cloudinary.com/dtqxebti9/image/upload/f_auto/v1751401471/Ca_Greenhouse-1_ffz9cb.heic"
              alt="Warehouse Projects"
              width={450}
              height={350}
          ...
          <div className="md:w-1/2 p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-600">Warehouse Projects</h2>
            <p className="text-gray-800 text-lg mb-2 font-semibold">Experts in Large-Scale Electrical Design.</p>
            <p className="text-gray-800 text-md">
              We design and build safe, high-capacity electrical systems for warehouses and distribution centers.
              Our work supports everything from high bay lighting to automation, conveyors, and advanced power management for logistics.
            </p>
          </div>
        </div>
      </section>
