      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full mx-auto flex bg-white/90 rounded-3xl shadow-2xl overflow-hidden flex-col md:flex-row">
          <div className="md:w-1/2 flex items-center justify-center p-8">
            <Image
              src="https://res.cloudinary.com/dtqxebti9/image/upload/f_auto/v1751402017/Sysparo-1_z7iuxc.jpg"
              alt="Office Projects"
              width={450}
              height={350}
          ...
          <div className="md:w-1/2 p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-600">Office Projects</h2>
            <p className="text-gray-800 text-lg mb-2 font-semibold">Creating Productive, Energy-Efficient Workspaces.</p>
            <p className="text-gray-800 text-md">
              ...
              We focus on reliability, flexibility, and cutting-edge energy efficiency.
            </p>
          </div>
        </div>
      </section>
