...
export default function GovernmentPortfolioPage() {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full mx-auto flex bg-white/90 rounded-3xl shadow-2xl overflow-hidden flex-col md:flex-row">
          <div className="md:w-1/2 flex items-center justify-center p-8">
            <Image
              src="https://res.cloudinary.com/dtqxebti9/image/upload/f_auto/v1751398014/Firesttion_8_1_1_w4h2go.jpg"
          ...
          <div className="md:w-1/2 p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-600">Government Projects</h2>
            <p className="text-gray-800 text-lg mb-2 font-semibold">Proven Experience in Public Sector Construction.</p>
            <p className="text-gray-800 text-md">
              ...
              Our experience with compliance and large-scale municipal work means every project is delivered safely, on schedule, and to the highest standards.
            </p>
          </div>
        </div>
      </section>
