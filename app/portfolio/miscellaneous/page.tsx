...
export default function MiscPortfolioPage() {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full mx-auto flex bg-white/90 rounded-3xl shadow-2xl overflow-hidden flex-col md:flex-row">
          <div className="md:w-1/2 flex items-center justify-center p-8">
            <Image
              src="https://res.cloudinary.com/dtqxebti9/image/upload/f_auto/v1751402525/Rexford_ps3tuq.heic"
          ...
          <div className="md:w-1/2 p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-600">Miscellaneous</h2>
            <p className="text-gray-800 text-lg mb-2 font-semibold">All Other Projects.</p>
            <p className="text-gray-800 text-md">
              Explore a variety of unique, challenging, or specialty electrical and lighting projects we’ve completed. 
              From custom installations to one-of-a-kind solutions, our versatility ensures every client gets the results they need.
            </p>
          </div>
        </div>
      </section>
