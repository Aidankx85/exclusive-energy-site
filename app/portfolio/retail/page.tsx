      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full mx-auto flex bg-white/90 rounded-3xl shadow-2xl overflow-hidden flex-col md:flex-row">
          <div className="md:w-1/2 flex items-center justify-center p-8">
            <Image
              src="https://res.cloudinary.com/dtqxebti9/image/upload/f_auto/v1751402284/Road_Runnersports-1_or8mt3.heic"
              alt="Retail Projects"
              width={450}
              height={350}
          ...
          <div className="md:w-1/2 p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-600">Retail & Food Chain</h2>
            <p className="text-gray-800 text-lg mb-2 font-semibold">Lighting Up Customer Experiences.</p>
            <p className="text-gray-800 text-md">
              We’ve helped power and remodel spaces for major retail and restaurant chains. 
              Our efficient, eye-catching electrical work meets strict brand requirements and tight buildout schedules.
            </p>
          </div>
        </div>
      </section>
