      ...
      <RotatingHero images={heroImages} className="min-h-screen" overlayClassName="bg-black/40">
        ...
        <div className="flex justify-center w-full">
          <div className="bg-white text-gray-800 rounded-xl shadow-xl flex flex-col md:flex-row items-center max-w-5xl w-full p-6 sm:p-10 gap-6 md:gap-10">
            <Image src="/what4.jpg" alt="Service & Maintenance" width={420} height={340} className="rounded-lg shadow-md object-cover w-full md:w-[420px] h-auto md:h-[340px] aspect-[4/3] md:aspect-auto" />
            <div className="hidden md:block h-full w-px bg-gray-300 mx-6" />
            <div className="flex flex-col justify-center max-w-xl">
              <h1 className="text-3xl font-bold text-blue-600 mb-4">Service & Maintenance</h1>
              <p className="text-lg mb-2">
                Scheduled inspections, maintenance, and 24/7 emergency response. Our techs keep your systems running smoothly and safely, minimizing downtime.
              </p>
              <p className="text-base">From panel upgrades to urgent repairs, Exclusive Energy & Electric has you covered.</p>
            </div>
          </div>
        </div>
        </div>
