      ...
      <section className="min-h-screen bg-cover bg-center flex flex-col justify-center items-center px-4 md:px-10 transition-all duration-1000 ease-in-out relative pt-48"
        ...
        <div className="relative z-10 flex justify-center w-full">
          <div className="bg-white text-gray-800 rounded-xl shadow-xl flex flex-col md:flex-row items-center max-w-5xl w-full p-10 gap-10">
            {/* Use an <video> here if you want animated! Otherwise use jpg/png. */}
            <Image src="/warehouse-robot-cover.jpg" alt="Warehouse Automation" width={420} height={340} className="rounded-lg shadow-md object-cover w-[420px] h-[340px]" />
            <div className="hidden md:block h-full w-px bg-gray-300 mx-6" />
            <div className="flex flex-col justify-center max-w-xl">
              <h1 className="text-3xl font-bold text-blue-600 mb-4">Warehouse Automation</h1>
              <p className="text-lg mb-2">
                Integrate robotics and automation for a smarter, safer warehouse. From autonomous forklifts to automated controls—streamline your operations and boost productivity.
              </p>
              <p className="text-base">Let’s bring your facility into the future with innovative automation solutions.</p>
            </div>
          </div>
        </div>
      </section>
